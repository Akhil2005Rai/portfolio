...
const Items = () => {
    ...
    <>
        <div className="a">
        <div className="row">
            <Sec link={mt} ttl="React-Native(Certificate)" tx="Verification link"/>
            <Sec link={krg} ttl="Cloud Computing(Certificate)" tx = "Verification link"/>
            <Sec link={tic} ttl="Cyber Security (Certificate)" tx="Verification link"/>
        </div>
        <div className="row">
        ...
        <div className="row">
            <Sec link={hng} ttl="Portfolio" tx="Github Link"/>
